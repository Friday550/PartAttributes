            ...
            try
            {
                ...
                string sql = @"INSERT INTO tblPartAttribute 
                    (attrPartNumber, attrStandard, attrIRrating, attrRatedCurrent, attrRMSSym, 
                     ...
                     attrPhaseConfig3, attrPhaseConfig4, attrPhaseConfig5, attrBreaker1, attrBreaker1Outlet, 
                     attrBreaker1Amps, attrBreaker2, attrBreaker2Outlet, attrBreaker2Amps, attrBreaker3, 
                     attrBreaker3Outlet, attrBreaker3Amps, attrBreaker4, attrBreaker4Outlet, attrBreaker4Amps, 
                     attrBreaker5, attrBreaker5Outlet, attrBreaker5Amps, attrSerialNumber) 
                VALUES 
                    (@PartNumber, @Standard, @IRRating, @RatedCurrent, @RMSSym, 
                     @SystemVolts, @Frequency, @Ground, @PhaseConfig1, @PhaseConfig2, 
                     @PhaseConfig3, @PhaseConfig4, @PhaseConfig5, @Breaker1, @Breaker1Outlet, 
                     @Breaker1Amps, @Breaker2, @Breaker2Outlet, @Breaker2Amps, @Breaker3, 
                     @Breaker3Outlet, @Breaker3Amps, @Breaker4, @Breaker4Outlet, @Breaker4Amps, 
                     @Breaker5, @Breaker5Outlet, @Breaker5Amps, @SerialNumber)";
